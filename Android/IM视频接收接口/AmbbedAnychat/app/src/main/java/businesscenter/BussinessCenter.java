...
import ambbedanychat.biggod.com.ambbedanychat.R;
import ambbedanychat.biggod.com.ambbedanychat.VideoActivity;
...
public class BussinessCenter{
	...
	public void onVideoCallRequest(int dwUserId, int dwFlags,
			int dwParam, String szUserStr,Context mC) {
		// TODO Auto-generated method stub
		System.out.println("要放音乐");
        mContext = (Activity) mC;
